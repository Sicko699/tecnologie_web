...
@section('content')
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-start mb-5">
            <div>
                <h1 class="h2 fw-light text-dark mb-2">Agenda</h1>
                ...
                <div class="bg-light bg-opacity-50 rounded-4 p-4 mb-4">
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="fw-medium">
                                {{ $agenda->created_at ? \Carbon\Carbon::parse($agenda->created_at)->format('d/m/Y') : '-' }}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white border border-light rounded-4 p-4">
                        ...
                        <div class="small text-muted">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span>
                                    {{ $agenda->updated_at ? \Carbon\Carbon::parse($agenda->updated_at)->format('d/m/Y') : '-' }}
                                </span>
                            </div>
                        </div>
                    </div>
